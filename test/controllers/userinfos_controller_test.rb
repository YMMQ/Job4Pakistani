...
class UserinfosControllerTest < ActionController::TestCase
  ...
  test "should create userinfo" do
    assert_difference('Userinfo.count') do
      post :create, userinfo: { address: @userinfo.address, date_of_birth: @userinfo.date_of_birth, gender: @userinfo.gender, mobile: @userinfo.mobile, user_id: @userinfo.user_id }
    end
  ...
  test "should update userinfo" do
    patch :update, id: @userinfo, userinfo: { address: @userinfo.address, date_of_birth: @userinfo.date_of_birth, gender: @userinfo.gender, mobile: @userinfo.mobile, user_id: @userinfo.user_id }
    assert_redirected_to userinfo_path(assigns(:userinfo))
  end
